...
md_path = os.path.join(os.path.expanduser('~'), 'knu-cse-announcements-crawler/markdown')
body_path = os.path.join(os.path.expanduser('~'), 'knu-cse-announcements-crawler/body')
